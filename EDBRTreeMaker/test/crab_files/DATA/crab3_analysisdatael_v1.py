...
config.General.requestName   = 'singleEl15BMay-v1'
...
#config.JobType.inputFiles = ['Summer15_25nsV7_DATA_L1FastJet_AK4PFchs.txt','Summer15_25nsV7_DATA_L2Relative_AK4PFchs.txt','Summer15_25nsV7_DATA_L3Absolute_AK4PFchs.txt','Summer15_25nsV7_DATA_L1FastJet_AK8PFchs.txt','Summer15_25nsV7_DATA_L2Relative_AK8PFchs.txt','Summer15_25nsV7_DATA_L3Absolute_AK8PFchs.txt']
...
#config.Data.lumiMask = 'Cert_246908-251252_13TeV_PromptReco_Collisions15_JSON.txt'#'lumiSummary_13_07_2015_JSON.txt'#https://twiki.cern.ch/twiki/pub/CMS/ExoDijet13TeV/lumiSummary_13_07_2015_JetHT.json'#https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions12/8TeV/Prompt/Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON.txt'
#config.Data.runRange = '251244-251252'#'250843-250932' # '193093-194075'
#config.Data.outLFNDirBase = '/store/user/%s/' % (getUsernameFromSiteDB())
config.Data.publication = False
config.Data.outputDatasetTag = 'singleEl15BMay-v1'
